...
@Mod(KibRobots.MODID)
public class KibRobots {
    public static final String MODID = "kibrobots";
    public static final Logger LOGGER = LogUtils.getLogger();

    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, MODID);
    
    public static final Supplier<CreativeModeTab> KIB_TECH_TAB = CREATIVE_MODE_TABS.register("kibrobots", () -> CreativeModeTab.builder()
        .title(Component.translatable("itemGroup." + MODID + ".kibrobots"))
    ...
    public KibRobots(IEventBus modEventBus, ModContainer modContainer) {

package com.joniski.kibrobots.item;
...
import com.joniski.kibrobots.item.custom.RobotItem;
...
public class ModItems {
        public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(KibRobots.MODID);

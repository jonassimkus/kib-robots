...
public class AdvancedSolarPanelScreen extends AbstractContainerScreen<AdvancedSolarPanelMenu>{

    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "textures/gui/solar_panel/solar_panel_gui.png");

    public AdvancedSolarPanelScreen(AdvancedSolarPanelMenu menu, Inventory playerInventory, Component title) {

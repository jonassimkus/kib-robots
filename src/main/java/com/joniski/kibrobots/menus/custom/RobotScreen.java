...
public class RobotScreen extends AbstractContainerScreen<RobotMenu>{
    ...
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "textures/gui/robot/robot_gui.png");

    private static final ResourceLocation COPPER_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "textures/gui/robot/copper_gui.png");

    private static final ResourceLocation IRON_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "textures/gui/robot/iron_gui.png");

    private static final ResourceLocation DIAMOND_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "textures/gui/robot/diamond_gui.png");


    private static final ResourceLocation NETHERITE_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "textures/gui/robot/netherite_gui.png");

package com.joniski.kibrobots.menus;

import java.util.function.Supplier;

import com.joniski.kibrobots.KibRobots;
import com.joniski.kibrobots.menus.custom.AdvancedSolarPanelMenu;
import com.joniski.kibrobots.menus.custom.BatteryChargerMenu;
import com.joniski.kibrobots.menus.custom.RobotMenu;
import com.joniski.kibrobots.menus.custom.RobotStationMenu;
...
public class ModMenus {
    public static final DeferredRegister<MenuType<?>> MENUS = 
            DeferredRegister.create(Registries.MENU, KibRobots.MODID);

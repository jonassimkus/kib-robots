...
public class NetheriteRobotModel<T extends RobotEntity> extends HierarchicalModel<T>{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "netherite_robot_entity"), "main");
	private final ModelPart Body;
	private final ModelPart Head;

	public NetheriteRobotModel(ModelPart root) {

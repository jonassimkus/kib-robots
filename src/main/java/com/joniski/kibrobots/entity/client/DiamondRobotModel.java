...
public class DiamondRobotModel<T extends RobotEntity> extends HierarchicalModel<T>{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "diamond_robot_entity"), "main");
	private final ModelPart Body;
	private final ModelPart Head;

	public DiamondRobotModel(ModelPart root) {

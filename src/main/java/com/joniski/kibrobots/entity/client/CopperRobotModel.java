...
public class CopperRobotModel<T extends RobotEntity> extends HierarchicalModel<T>{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(KibRobots.MODID, "copper_robot_entity"), "main");
